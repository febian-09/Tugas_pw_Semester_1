...
if ($search) {
    $stmt = $conn->prepare("SELECT * FROM pelanggan WHERE nama LIKE ? OR email LIKE ? OR no_hp LIKE ? ORDER BY id DESC");
    $like = "%$search%";
...
<?php if (isset($_GET['msg'])): ?>
    <div class="alert alert-success alert-dismissible fade show">
        <?php
        $msgs = ['added' => 'Pelanggan berhasil ditambahkan.', 'updated' => 'Pelanggan berhasil diubah.', 'deleted' => 'Pelanggan berhasil dihapus.'];
